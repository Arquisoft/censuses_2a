...
*/	
	...
	private static void crearDB() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        String createTables = "CREATE TABLE VOTANTES(ID BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,NOMBRE VARCHAR(32768),EMAIL VARCHAR(32768),NIF VARCHAR(32768),CODCOLEGIO INTEGER,PASSWORD VARCHAR(32768))";
